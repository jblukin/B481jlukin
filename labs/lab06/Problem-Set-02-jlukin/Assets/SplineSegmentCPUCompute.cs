...
namespace PS02 {
    ...
    public class SplineSegmentCPUCompute : MonoBehaviour {
        ...
        private void Update() {
            ...
            // (e.g. for the Bezier spline matrix, as from Lecture 10 notes )
            //
            ...
            for (int i = 0; i < curvePoints; i++) {
                ...
                //      (4-element vector defined as in Lecture 10 notes,
                ...
                // so ...
                // 
                  Vector4 uRow = new( Mathf.Pow(u, 3), Mathf.Pow(u, 2), (u), (1) );
                ...
                // TODO - properly create the matrix of control points: 
                 ...
                 /*new Vector4(control0.position.x, control1.position.x, control2.position.x, control3.position.x),
                 new Vector4(control0.position.y, control1.position.y, control2.position.y, control3.position.y),
                 new Vector4(control0.position.z, control1.position.z, control2.position.z, control3.position.z),
                 Vector4.one*/
                 );
                ...
                //splineCurve.SetPosition(i, splinePointPosition);
            } // end of for i ...
    ...
    } // end of class SplineSegmentCPUCompute
